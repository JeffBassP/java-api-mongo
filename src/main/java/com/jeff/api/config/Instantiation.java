...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2021"),"Partiu Viagem", "Viagem para NY, muito legal!!", maria );
		Post post2 = new Post(null, sdf.parse("23/03/2021"),"Bom dia", "Um excelente dia a todos.", maria );
